...
public class SalaryMasterServcieImpl implements SalaryMasterService {
	...
	@Autowired
	SalaryMasterRepository salaryMasterRepository;
	@Autowired
	...
	@Override
	@Transactional
	public int confirmSelected(String companyCode, List<String> salaryIds) {
		if (companyCode == null || salaryIds == null || salaryIds.isEmpty()) {
			throw new IllegalArgumentException("companyCode 또는 salaryIds가 비어 있습니다.");
		}
		return salaryMasterRepository.confirmSelected(companyCode, salaryIds);
	}
